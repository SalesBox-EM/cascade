                ...
                <div className='w-full h-full  grid lg:grid-cols-3 gap-6 items-start justify-center'>
                    <div className='w-full flex flex-col items-start gap-4  max-w-[500px] h-full'>
                        ...
                        <div className='w-full flex flex-col justify-between h-full gap-3 '>
                            <h3 className='text-black text-3xl mb-3 w-2/3 '>The Invisible Barrier to Business Breakthroughs</h3>
                            <h6>May 10, 2023</h6>
                    ...
                    <div className='w-full flex flex-col items-start gap-4  max-w-[500px] h-full'>
                        ...
                        <div className='w-full flex flex-col justify-between h-full gap-3   '>
                            <h3 className='text-black text-3xl mb-3 w-2/3 '>AI & Beyond: Leadership
                                Adaption</h3>
                            <h6>May 10, 2023</h6>
                            <div className='inline-flex items-baseline flex-wrap '>
                    ...
                    <div className='w-full flex flex-col items-start gap-4  max-w-[500px] h-full'>
                        ...
                        <div className='w-full flex flex-col justify-between h-full gap-3 '>
                            <h3 className='text-black text-3xl mb-3 w-2/3'>Actionable Ideas Need Engaged Execs</h3>
                            <h6>May 10, 2023</h6>
                            <div className='inline-flex items-baseline flex-wrap '>
