    ...
    return (
        <div id='head' className='w-full h-full '>
            ...
            <div className='w-full h-full  flex flex-col items-center justify-center'>
                ...
                <img src={ImageThree} className='xl:w-[80%] max-w-[1261px] w-[95%] mt-[130px]    object-cover     ' alt="" />
                ...
                <div className='xl:w-[80%] max-w-[1261px] w-[95%] h-full flex flex-col mt-6 gap-6'>
                    ...
                    <div>
                        <h5 className='text-zinc-800 text-lg font-semibold  xl:text-xl 2xl:text-2xl mb-1 '>Microsoft Case Study
                        </h5>
                        <p>
